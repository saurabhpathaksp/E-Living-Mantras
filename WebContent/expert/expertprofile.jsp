...
ExpertRegister er= task.viewprofile(id);
{%> 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-work">
                            <p>Experiences</p>
                            <a href=""><%=er.getExpertexp() %> year</a><br/>
                            
                            <p>SKILLS</p>
                            <a href=""><%=er.getExpertskill() %> </a><br/>
